...
class ModelUse() :
    ...
    def M0_1_1(self, functionInfo):
        ...
        functionVersionInfo = copy.deepcopy(functionInfo["ParameterJson"]["M0_1_1"])
        functionVersionInfo["Version"] = "M0_1_1"
        globalObjectFDict = GainObjectCtrl.getObjectsById(functionInfo["GlobalObject"])["P0_1_1"]
    ...
    @classmethod
    def M0_1_2(self, functionInfo):
        import copy , pandas
        from package.common.osbasic.GainObjectCtrl import GainObjectCtrl
        from sklearn.metrics.pairwise import cosine_similarity
        from sklearn.feature_extraction.text import CountVectorizer

        functionVersionInfo = copy.deepcopy(functionInfo["ParameterJson"]["M0_1_2"])
        functionVersionInfo["Version"] = "M0_1_2"
        globalObject = GainObjectCtrl.getObjectsById(functionInfo["GlobalObject"])
        mainKeysDF = globalObject["M0_1_1"]["ResultDF"]
