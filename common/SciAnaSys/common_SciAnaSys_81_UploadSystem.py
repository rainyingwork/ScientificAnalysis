...
sshCtrl.uploadFile("LocalConfig.py","/mfs/Docker/Python39/Volumes/Data/ScientificAnalysis/LocalConfig.py")
sshCtrl.uploadFile("OPSCommon.py","/mfs/Docker/Python39/Volumes/Data/ScientificAnalysis/OPSCommon.py")
sshCtrl.uploadFile("OPSCommonLocal.py","/mfs/Docker/Python39/Volumes/Data/ScientificAnalysis/OPSCommonLocal.py")