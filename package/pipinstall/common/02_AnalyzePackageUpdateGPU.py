...
# Pytorch套件 -------------------------------------------------
os.system("{} -m {} torch==2.0.1 --extra-index-url https://download.pytorch.org/whl/cu118".format(__pythonexePath,__pipFunction))           # 深度學習套件
os.system("{} -m {} torchvision==0.15.2 --extra-index-url https://download.pytorch.org/whl/cu118".format(__pythonexePath,__pipFunction))     # 深度學習套件
os.system("{} -m {} torchaudio==2.0.2 --extra-index-url https://download.pytorch.org/whl/cu118".format(__pythonexePath,__pipFunction))      # 深度學習套件
# Tensorflow 套件 -------------------------------------------------
