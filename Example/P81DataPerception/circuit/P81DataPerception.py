...
class DataPerception():
    ...
    @classmethod
    def DP1_0_1(self, functionInfo):
        import copy
        from package.artificialintelligence.common.dataperception.DataPercoptionFunction import DataPercoptionFunction
        dataPercoptionFunction = DataPercoptionFunction()
        functionVersionInfo = copy.deepcopy(functionInfo["ParameterJson"]["DP1_0_1"])
        functionVersionInfo["Version"] = "DP1_0_1"
        resultObject, globalObjectDict = dataPercoptionFunction.executionFunctionByFunctionType(functionVersionInfo)
        return resultObject, globalObjectDict

    @classmethod
    def DP1_1_1(self, functionInfo):
        import copy
        from package.artificialintelligence.common.dataperception.DataPercoptionFunction import DataPercoptionFunction
        dataPercoptionFunction = DataPercoptionFunction()
        functionVersionInfo = copy.deepcopy(functionInfo["ParameterJson"]["DP1_1_1"])
        functionVersionInfo["Version"] = "DP1_1_1"
        resultObject, globalObjectDict = dataPercoptionFunction.executionFunctionByFunctionType(functionVersionInfo)
        return resultObject, globalObjectDict

    @classmethod
    def DP1_1_2(self, functionInfo):
        import copy
        from package.artificialintelligence.common.dataperception.DataPercoptionFunction import DataPercoptionFunction
        dataPercoptionFunction = DataPercoptionFunction()
        functionVersionInfo = copy.deepcopy(functionInfo["ParameterJson"]["DP1_1_2"])
        functionVersionInfo["Version"] = "DP1_1_2"
        resultObject, globalObjectDict = dataPercoptionFunction.executionFunctionByFunctionType(functionVersionInfo)
        return resultObject, globalObjectDict